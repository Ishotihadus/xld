...
- (BOOL)preTrackSamplesCommitted
{
	return preTrackSamplesCommitted;
}

- (BOOL)postTrackSamplesCommitted
{
	return postTrackSamplesCommitted;
}

- (xldoffset_t)startOfPreTrack
{
	return startOfPreTrack;
}

- (void)setStartOfPreTrack:(xldoffset_t)frame
{
	startOfPreTrack = frame;
}
