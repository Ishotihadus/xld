...
- (NSMutableDictionary *)configurations
{
	...
	switch([[o_encoderMode selectedItem] tag]) {
		case 0:
			[cfg setObject:[NSString stringWithFormat:@"VBR, %d kbps",[self bitrate]/1000] forKey:@"ShortDesc"];
		case 1:
			[cfg setObject:[NSString stringWithFormat:@"Constrained VBR, %d kbps",[self bitrate]/1000] forKey:@"ShortDesc"];
		case 2:
			[cfg setObject:[NSString stringWithFormat:@"CBR, %d kbps",[self bitrate]/1000] forKey:@"ShortDesc"];
	}
